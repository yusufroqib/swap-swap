...
import { UNIVERSAL_ROUTER_ADDRESS } from '@zentraswap/universal-router-sdk'
import { useWeb3React } from '@web3-react/core'
import { ChainId, Currency, CurrencyAmount, Percent, Token } from '@zentraswap/sdk-core'
  ...
  return (
    <>
      <PageWrapper>
        <Swap
          className={className}
          chainId={supportedChainId ?? ChainId.PHAROS_DEVNET}
